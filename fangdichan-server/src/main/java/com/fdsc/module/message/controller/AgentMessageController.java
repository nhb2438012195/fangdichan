...
public class AgentMessageController {
    ...
    public Result<List<Conversation>> listConversations(@AuthenticationPrincipal Long userId) {
        return Result.success(messageService.listConversations(userId, "AGENT"));
    }
    ...
    public Result<?> sendMessage(@AuthenticationPrincipal Long userId,
                                  @PathVariable Long conversationId,
                                  @RequestParam String content) {
        messageService.sendMessage(conversationId, userId, "AGENT", content);
